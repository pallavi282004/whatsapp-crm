...
from .routes import broadcast, contacts, auth, woocommerce, integration, wallet, analytics
...
# Add routers (user router with no prefix since routes already start with /api/)
app.include_router(broadcast.router)
app.include_router(contacts.router)
app.include_router(user_router, prefix="/api")  # Correct import and prefix for /api/signup/ and /api/login/
