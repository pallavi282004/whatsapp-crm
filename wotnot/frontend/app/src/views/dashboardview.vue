...
<script>
// Removed unused FB global declaration
...
export default {
  ...
  data() {
    return {
      ...
      navItems: [
        ...
        { name: 'messagegenerator', label: 'Message Generator', icon: 'bi bi-chat-dots', path: '/dashboard/messagegenerator' }
      ],
      user: null,
      dropdownOpen: false,
  ...
  async mounted() {
    ...
    // Facebook SDK and FB.init references removed
